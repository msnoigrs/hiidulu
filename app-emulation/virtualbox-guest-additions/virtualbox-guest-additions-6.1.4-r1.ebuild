...
src_prepare() {
	...
	kmk GuestDrivers-src vboxguest-src vboxvideo-src &>/dev/null || die
	eend
	popd &>/dev/null || die
	...
	eapply "${FILESDIR}/remove-vboxsf.patch"
	rm -r src/VBox/Additions/linux/sharedfolders || die
	rm src/VBox/Additions/common/VBoxService/VBoxServiceAutoMount.cpp || die
