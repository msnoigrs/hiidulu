...
MY_PVV="2015_pre37502"
MY_PV="texlive-${MY_PVV}-source"
...
S="${WORKDIR}/texlive-${MY_PVV}-source/texk/bibtex-x"
...
for i in ${EXTRA_TL_MODULES} ; do
	...
	SRC_URI="${SRC_URI} http://dev.gentoo.gr.jp/~igarashi/distfiles/texlive-module-${i}-${MY_PVV}.tar.xz"
done
