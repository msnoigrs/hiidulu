...
src_prepare() {
	...
	sed -i -e 's/file_string/string/g' contrib/organize/organize.cpp
	sed -i -e 's/p_iter->filename/p_iter->path().filename/g' contrib/organize/organize.cpp
	sed -i -e 's/dest.extension/dest.extension().string/g' contrib/organize/organize.cpp
	sed -i -e 's/dest.stem/dest.stem().string/g' contrib/organize/organize.cpp
#	sed -i -e \
