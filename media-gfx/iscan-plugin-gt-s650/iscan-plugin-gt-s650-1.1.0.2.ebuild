...
QA_PREBUILT="/opt/iscan/lib/libiscan-plugin-gt-s650.so*"
...
pkg_setup() {
	basecmds=(
		"iscan-registry --COMMAND interpreter usb 0x04b8 0x013d /opt/iscan/lib/libiscan-plugin-gt-s650 /usr/share/iscan/esfw010c.bin"
	)
}
