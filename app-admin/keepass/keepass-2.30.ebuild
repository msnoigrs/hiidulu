...
src_prepare() {
	...
	#sed -i -e 's/ToolsVersion="3.5"/ToolsVersion="4.0"/g' \
	#	KeePass/KeePass.csproj \
	#	KeePassLib/KeePassLib.csproj \
	#	KeePassLibSD/KeePassLibSD.csproj \
	#	Translation/TrlUtil/TrlUtil.csproj

	find . -name "*.sln" -print -exec sed -i -e 's/Format Version 10.00/Format Version 11.00/g' {} \;
	find . -name "*.csproj" -print -exec sed -i -e 's#ToolsVersion="3.5"#ToolsVersion="4.0"#g;s#<TargetFrameworkVersion>.*</TargetFrameworkVersion>##g;s#<PropertyGroup>#<PropertyGroup><TargetFrameworkVersion>v4.5</TargetFrameworkVersion>#g' {} \;
