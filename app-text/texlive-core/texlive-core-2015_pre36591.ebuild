...
SRC_URI="http://dev.gentoo.gr.jp/~igarashi/distfiles/${MY_PV}.tar.xz"
#SRC_URI="mirror://gentoo/${MY_PV}.tar.xz"

# Fetch patches
#SRC_URI="${SRC_URI} mirror://gentoo/${PN}-patches-${PATCHLEVEL}.tar.xz"
SRC_URI="${SRC_URI} http://dev.gentoo.gr.jp/~igarashi/distfiles/${PN}-patches-${PATCHLEVEL}.tar.xz"
...
for i in ${TL_CORE_EXTRA_MODULES}; do
	SRC_URI="${SRC_URI} http://dev.gentoo.gr.jp/~igarashi/distfiles/texlive-module-${i}-${PV}.tar.xz"
done

SRC_URI="${SRC_URI} doc? ( "
for i in ${TL_CORE_EXTRA_DOC_MODULES}; do
	SRC_URI="${SRC_URI} mirror://gentoo/texlive-module-${i}-2014.tar.xz"
done
SRC_URI="${SRC_URI} )"
...
IUSE="cjk X doc source tk xetex luatex"
