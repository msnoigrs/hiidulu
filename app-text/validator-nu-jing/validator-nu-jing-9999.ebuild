...
ESVN_REPO_URI="http://jing-trang.googlecode.com/svn/branches/validator-nu"
#EHG_REPO_URI="https://bitbucket.org/validator/jing-trang"
...
#	epatch "${FILESDIR}"/schematron-warnings.patch
	...
	sed -i -e 's/net.sf.saxon.FeatureKeys/net.sf.saxon.lib.FeatureKeys/' mod/schematron/src/main/com/thaiopensource/validate/schematron/NewSaxonSchemaReaderFactory.java
