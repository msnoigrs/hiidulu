...
ESVN_REPO_URI="http://svn.apache.org/repos/asf/xerces/java/trunk"

inherit subversion eutils versionator java-pkg-2 java-ant-2
...
EANT_GENTOO_CLASSPATH="xml-commons-resolver,xml-commons-external-1.4,xalan-serializer"
