...
ESVN_REPO_URI="https://svn.java.net/svn/jna~svn/trunk/jnalib"

JAVA_PKG_IUSE="test doc source"
WANT_ANT_TASKS="ant-nodeps"

inherit subversion java-pkg-2 java-ant-2 toolchain-funcs flag-o-matic
...
java_prepare() {
	...
	# fix build.xml file
	epatch "${FILESDIR}/3.2.7-makefile-flags.patch" "${FILESDIR}/3.2.7-build.xml.patch"
