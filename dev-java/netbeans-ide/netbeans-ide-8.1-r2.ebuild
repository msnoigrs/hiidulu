...
src_prepare() {
	...
	java-pkg_jar-from --into c.jcraft.jzlib/external jzlib-1.1.3 jzlib.jar jzlib-1.0.7.jar
...
src_install() {
	...
	rm com-jcraft-jzlib.jar && dosym /usr/share/jzlib-1.1.3/lib/jzlib.jar ${instdir}/com-jcraft-jzlib.jar || die
	popd >/dev/null || die
