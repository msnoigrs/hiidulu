...
CDEPEND="~dev-java/netbeans-ide-${PV}
	...
	dev-java/geronimo-spec-javaee-deployment"
...
src_prepare() {
	...
	java-pkg_jar-from --into j2eeapis/external geronimo-spec-javaee-deployment geronimo-spec-javaee-deployment.jar jsr88javax.jar
...
src_install() {
	...
	rm jsr88javax.jar && dosym /usr/share/geronimo-spec-javaee-deployment/lib/geronimo-spec-javaee-deployment.jar ${instdir}/jsr88javax.jar || die
	popd >/dev/null || die
	...
	pushd "${D}"/${instdir} >/dev/null || die
	rm cglib-2.2.0-b21.jar && dosym /usr/share/cglib-nodep-3/lib/cglib-nodep.jar ${instdir}/cglib-2.2.0-b21.jar || die
