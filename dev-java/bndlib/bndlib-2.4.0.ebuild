...
java_prepare() {
	...
	cp "${FILESDIR}/nbdlib-build.xml" build.xml
	cp "${FILESDIR}/nbdlib-build.xml" ../aQute.libg/build.xml

	java-ant_rewrite-classpath "${WORKDIR}/bnd-${PV}.REL/aQute.libg/build.xml"
