...
WANT_ANT_TASKS="dev-java/package-rename-task:0
	...
	dev-java/istack-commons:0 ant-trax ant-junit"
...
SRC_URI="http://jaxb.java.net/2.2.7/jaxb-ri-2.2.7.src.zip"
...
#	cp "${FILESDIR}/ErrorListener.java" runtime/src/com/sun/xml/bind/api

	sed -i -e '/target="bundle"/ d' build.xml
...
#	rm -v tools/lib/redist2.2/*
	...
	mv ${T}/bnd-0.0.249.jar tools/lib/util
...
#	java-pkg_jar-from --into ${S}/runtime codemodel-2
	...
	java-pkg_jar-from --into ${S}/tools/lib/util stax-ex
	java-pkg_jar-from --into ${S}/tools/lib/util args4j-1 args4j.jar args4j.jar
	...
	java-pkg_jar-from --into ${S}/tools/lib/rebundle/compiler istack-commons
	...
	java-pkg_jar-from --into ${S}/tools/lib/rebundle/compiler --build-only ant-core ant.jar

	java-pkg_jar-from --into ${S}/tools/lib/util iso-relax
	java-pkg_jar-from --into ${S}/tools/lib/util xsdlib
...
#	java-pkg_jar-from --into ${S}/tools/lib/rebundle/runtime relaxng-datatype
	...
	java-pkg_jar-from --into ${S}/tools/lib/util --build-only junit junit.jar junit-3.8.1.jar
