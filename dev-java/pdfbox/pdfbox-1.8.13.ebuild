...
JAVA_GENTOO_CLASSPATH="fontbox-${SLOT},jempbox-${SLOT},bcmail-${BC_SLOT},bcprov-${BC_SLOT},jcl-over-slf4j,icu4j-55"
...
src_install() {
	...
	java-pkg_dolauncher ${PN}-1.8 --main org.apache.${PN}.PDFBox
}
