...
src_compile() {
	ANT_TASKS="ant-nodeps" ant -Drebuild.cluster.name=nb.cluster.websvccommon -Dext.binaries.downloaded=true rebuild-cluster
	cd websvc.saas.api
	ant
	cd ..
	ANT_TASKS="ant-nodeps" ant -Drebuild.cluster.name=nb.cluster.websvccommon -Dext.binaries.downloaded=true rebuild-cluster
	cd websvc.saas.codegen
	ant
	cd ..
	ANT_TASKS="ant-nodeps" ant -Drebuild.cluster.name=nb.cluster.websvccommon -Dext.binaries.downloaded=true rebuild-cluster
	cd websvc.saas.services.strikeiron
	ant
	cd ..
	ANT_TASKS="ant-nodeps" ant -Drebuild.cluster.name=nb.cluster.websvccommon -Dext.binaries.downloaded=true rebuild-cluster
	cd websvc.saas.ui
