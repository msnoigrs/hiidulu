...
ESVN_REPO_URI="http://hamcrest.googlecode.com/svn/trunk/hamcrest-java"
...
#	epatch "${FILESDIR}/qdox-fix.patch"
...
src_install() {
	...
	java-pkg_newjar build/hamcrest-generator-9999.jar hamcrest-generator.jar
