...
EGIT_REPO_URI="https://github.com/apache/fop.git"
EGIT_BRANCH="trunk"
...
src_compile() {
	...
	java-pkg_jar-from --into lib slf4j-api slf4j-api.jar commons-logging-slf4j-api.jar
	java-pkg_jar-from --into lib logback-core logback-core.jar commons-logging-logback-core.jar
	java-pkg_jar-from --into lib logback-classic logback-classic.jar commons-logging-logback-classic.jar
	java-pkg_jar-from --into lib commons-io-1 commons-io.jar
	java-pkg_jar-from --into lib fontbox-1.8 fontbox.jar
