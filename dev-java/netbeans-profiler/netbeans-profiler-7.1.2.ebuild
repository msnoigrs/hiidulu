...
# $Header: /var/cvsroot/gentoo-x86/dev-java/netbeans-profiler/netbeans-profiler-7.1.1.ebuild,v 1.1 2012/03/05 14:20:15 fordfrog Exp $
...
src_install() {
	...
	rm -rfv lib/deployed/jdk*/solaris*
	rm -rfv lib/deployed/jdk*/hpux*
