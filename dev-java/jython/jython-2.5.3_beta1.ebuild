...
SRC_URI="http://www.python.org/ftp/python/${PYVER%_*}/Python-${PYVER}.tgz
	https://bitbucket.org/jython/jython/get/c5567b7757e7.tar.bz2 -> ${P}.tar.bz2"
...
S="${WORKDIR}/jython-jython-c5567b7757e7"
...
#	epatch "${FILESDIR}/${PN}-2.5.1-build.patch"
	...
	java-pkg_jar-from --into extlibs --build-only guava guava.jar guava-r07.jar
