...
HOMEPAGE="http://www.oracle.com/technetwork/java/javamail/index.html"
SRC_URI="http://java.net/projects/javamail/downloads/download/source/javamail-${PV}-src.zip"
