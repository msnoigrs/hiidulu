...
inherit eutils gnome2-utils multilib python vala virtualx git-2 autotools
...
src_prepare() {
	echo "AM_GNU_GETTEXT_VERSION(0.18.1)" >> "${S}"/configure.ac
...
#	eautoreconf
	...
	CFLAGS="$CFLAGS" . gnome-autogen.sh
